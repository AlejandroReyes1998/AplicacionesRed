...
public class Servidor {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            for (;;) {
                ...
                DataOutputStream dos = new DataOutputStream(new FileOutputStream("/home/alejandro/recibidos/" + arch));
                ...
                File tmpDir2 = new File("/home/alejandro/recibidos/compress.zip");
                /*
                ...
                if (exists) {
                    ...
                    tmpDir.delete();
                    tmpDir2.delete();
                    JOptionPane.showMessageDialog(null, "Directorio subido a servidor");
                } else {
                    JOptionPane.showMessageDialog(null, "Archivo subido a servidor");
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static void unZip() throws IOException {
        ...
        try (ZipFile file = new ZipFile("/home/alejandro/comprimir/compress.zip")) {
            ...
            String uncompressedDirectory = "/home/alejandro/recibidos/";
